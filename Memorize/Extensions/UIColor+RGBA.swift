...
extension Color { init(_ rgb: UIColor.RGB) { self.init(UIColor(rgb)) } }
...
extension UIColor {
    ...
    convenience init(_ rgb: RGB) { self.init(red: rgb.red, green: rgb.green, blue: rgb.blue, alpha: rgb.alpha) }
